...
const processSteps: ProcessStep[] = [
  { number: "01", title: "ご相談", description: "お客様のビジョンを<br />お聞かせください。<br />まずはXのリプライかDMでお気軽にご連絡ください。" },
  { number: "02", title: "ヒアリング", description: "詳細な要望をお伺いするための<br />ヒアリングを行います。<br />ご希望の内容や予算、納期などをお知らせください。" },
  { number: "03", title: "デザイン制作", description: "ヒアリング内容をもとに、<br />オリジナルデザインを制作します。<br />馬の特徴や厩舎のイメージを大切にしたデザインをご提案します。" },
  { number: "04", title: "レビュー・修正", description: "制作したデザインをご確認いただき、必要に応じて修正を行います。<br />ご満足いただけるまで調整いたします。" },
  { number: "05", title: "印刷・制作", description: "最終デザインが確定したら、<br />印刷・制作に進みます。<br />高品質な仕上がりを実現するため、信頼できる業者と連携しています。" },
  { number: "06", title: "お届け", description: "完成した商品をお届けします。<br />印刷所から直接お届けする場合もございます。" }
];

export const Process: React.FC = () => {
  const headerRef = useFadeInOnScroll<HTMLDivElement>();
  const cardRefs = [
    useFadeInOnScroll<HTMLDivElement>(),
    useFadeInOnScroll<HTMLDivElement>(),
    useFadeInOnScroll<HTMLDivElement>(),
    useFadeInOnScroll<HTMLDivElement>(),
    useFadeInOnScroll<HTMLDivElement>(),
