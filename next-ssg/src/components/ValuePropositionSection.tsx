...
export const ValuePropositionSection: React.FC = () => {
  const cardRefs = [useFadeInOnScroll<HTMLDivElement>(), useFadeInOnScroll<HTMLDivElement>(), useFadeInOnScroll<HTMLDivElement>()];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 w-full h-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
        {/* 見出し群 */}
        <div ref={useFadeInOnScroll<HTMLDivElement>()}>
