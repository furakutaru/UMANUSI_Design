...
export const ProfileContent: React.FC<ProfileContentProps> = ({ headingRef, contentRef }) => {
      ...
      <div ref={contentRef} style={{ transitionDelay: '0.3s' }}>
        ...
        <div className="mt-8 md:mt-12 w-full md:max-w-[700px] mx-auto md:mx-0">
          ...
          <div
            ...
            style={{ 
              maxHeight: isAccordionOpen ? `${accordionContentRef.current?.scrollHeight}px` : '0px',
