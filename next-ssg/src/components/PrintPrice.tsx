...
interface PrintPriceItem {
  productName: string;
  amount: string;
  additionalText?: string;
}

const printPriceData: PrintPriceItem[] = [
  { productName: "名刺20部両面カラー", amount: "1,050", additionalText: "（送料込み）" },
  { productName: "横断幕90×110cm", amount: "5,8845", additionalText: "（送料込み）" },
...
export const PrintPrice: React.FC = () => {
