...
export const FooterButton = ({
  ...
  return (
    ...
    >
      ...
      <span className="absolute left-16 h-8 text-xl font-semibold leading-8 text-center text-red-600 top-[18px] w-[220px] max-sm:left-2/4 max-sm:w-auto max-sm:-translate-x-2/4">
        {children}
      </span>
