    ...
    <footer className="w-full bg-red-700">
      <section id="contact" className="w-full bg-red-700 py-12 md:py-16">
        <div className="max-w-[800px] mx-auto px-4 flex flex-col items-center gap-8 md:gap-10">
          <h1 ref={titleRef.ref} className="text-3xl md:text-4xl font-bold text-white text-center">
            ご相談・お問い合わせ
          </h1>
          <h2 
            ref={subtitleRef.ref} 
          ...
          <div ref={buttonRef.ref} style={{ transitionDelay: '0.6s' }} className="w-[90vw] md:w-[340px] py-4">
